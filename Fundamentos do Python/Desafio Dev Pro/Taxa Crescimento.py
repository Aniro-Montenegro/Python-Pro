...
while pais_A < pais_B:
    pais_A = int(pais_A + (pais_A * taxa_crescimento_A))
    pais_B = int(pais_B + (pais_B * taxa_crescimento_B))
    anos += 1
print(f'Levará {anos} anos para o País A ter uma população pelo menos igual ao País B')
print(f'País A ={pais_A}')
print(f'País B ={pais_B}')